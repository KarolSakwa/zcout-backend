...
class ClubColorsSeeder extends Seeder
{
    public function run(): void
    {
        $clubs = [
            ...
            ['nameLike' => 'Coventry%',                 'p' => '#3A64A2', 's' => '#FFFFFF', 't' => '#E8E8E8'],
            ...
            ['nameLike' => 'Hull%',                     'p' => '#F5A12C', 's' => '#000000', 't' => '#FFFFFF'],
            ['nameLike' => 'Ipswich%',                  'p' => '#0033A0', 's' => '#FFFFFF', 't' => '#DE0429'],
            ...
            ['nameLike' => 'Sunderland%',               'p' => '#EB172B', 's' => '#FFFFFF', 't' => '#000000'],
